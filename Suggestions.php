...
<head>
  ...
  <title><?php echo SiteName; ?> - Suggestions</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="Suggestions.php"><i class="fa fa-users"></i> Suggestions</a></li>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        <i class="fa fa-ticket"></i> Suggestions
        <small></small>
      </h1>
      <ol class="breadcrumb">
		...
		<div class="col-md-13"><br>
          <div class="box box-solid box-<?php echo $theme2; ?>">
            ...
            <div class="box-body">
				...
				<div class="box box-solid box-<?php echo $theme2; ?>">
            <div class="box-header with-border">
              <h3 class="box-title">Create Suggestion</h3>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                      <label for="suggestiontitle">Suggestions Title:</label>
                      <input type="text" class="form-control" id="suggestiontitle" name="suggestiontitle" placeholder="Enter Suggestions Title">
                    </div>
                    <div class="form-group">
                      <label for="suggestiontext">Suggestions Text:</label>
                      <textarea type="text" rows="5" placeholder="What Happened?" id="suggestiontext" name="suggestiontext" class="form-control"></textarea>
					</div>
					<div class="pull-right">
					    <button onClick="CreateSuggestion()" class="btn btn-<?php echo $theme2; ?>">Create Suggestions</button>
					</div>
                </div>
              </div>
            </div>
			...
			<?php
            $stmt = $DB->DB->prepare("SELECT * FROM `suggestions` ORDER BY id");
    		$ok = $stmt->execute();
...
<?php if($MAIN->IsOWNER() || $MAIN->IsAdmin() || $MAIN->IsStaff()){ ?>
<script>
function Del(id) {
		$.ajax({
			type: "POST",
			url: "plugins/Suggestions/Del.php",
			data: "id="+id ,
			success: function(html) {
                $.toaster({ priority : 'success', title : 'Success', message : '</br>Suggestion Deleted!'});
